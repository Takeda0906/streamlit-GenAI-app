...
def select_model():
    ...
    if model_choice == "GPT-3.5":
        st.session_state.model_name = "gpt-3.5-turbo"
        return ChatOpenAI(model_name=str(st.session_state.model_name), temperature=float(temperature))
        ...
        return ChatAnthropic(model=str(st.session_state.model_name), temperature=float(temperature))
    elif model_choice == "Gemini 2.5 Pro":
        st.session_state.model_name = "gemini-2.5-pro"
        return ChatGoogleGenerativeAI(model=str(st.session_state.model_name), temperature=float(temperature))
